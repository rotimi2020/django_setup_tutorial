# Django Setup Tutorial (Silent Python Lab)

Welcome to the **Silent Python Lab** Django tutorial series!  

This repository will contain all the tutorials in the series. Each tutorial is organized in its own folder, so you can follow step by step.
